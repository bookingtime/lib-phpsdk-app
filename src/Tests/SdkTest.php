...
class SdkTest extends TestCase {
	...
	public function testSdk():void {
		...
		$this->assertEquals($appointment['mock-content'],1);
		$appointment=$sdk->appointment_uncancel(['organizationId'=>'f6xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','appointmentId'=>'edxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx']);
		$this->assertEquals($appointment['mock-content'],1);
		...
		$appointmentTemplateSimple=$sdk->appointmentTemplate_copy(['organizationId'=>'f6xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','appointmentTemplateId'=>'eaxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'],$data);
		$this->assertEquals($appointmentTemplateSimple['mock-content'],1);
		...
		$appointmentTemplateComplex=$sdk->appointmentTemplate_show(['organizationId'=>'f6xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','appointmentTemplateId'=>'vcxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx']);
		$this->assertEquals($appointmentTemplateComplex['mock-content'],1);
		$appointmentTemplateComplex=$sdk->appointmentTemplate_identify(['organizationId'=>'f6xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','appointmentTemplateId'=>'vcxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','customId'=>'1234']);
		$this->assertEquals($appointmentTemplateComplex['mock-content'],1);
		$data=['name'=>'Terminvorlage complex copied'];
		$appointmentTemplateComplex=$sdk->appointmentTemplate_copy(['organizationId'=>'f6xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','appointmentTemplateId'=>'vcxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'],$data);
		$this->assertEquals($appointmentTemplateComplex['mock-content'],1);
		$data=['name'=>'Terminvorlage complex edited'];
		$appointmentTemplateComplex=$sdk->appointmentTemplate_edit(['organizationId'=>'f6xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','appointmentTemplateId'=>'vcxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'],$data);
		$this->assertEquals($appointmentTemplateComplex['mock-content'],1);
		$appointmentTemplateComplex=$sdk->appointmentTemplate_emailTemplate_link(['organizationId'=>'f6xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','appointmentTemplateId'=>'vcxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','emailTemplateId'=>'46xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx']);
		$this->assertEquals($appointmentTemplateComplex['mock-content'],1);
		$appointmentTemplateComplex=$sdk->appointmentTemplate_emailTemplate_unlink(['organizationId'=>'f6xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','appointmentTemplateId'=>'vcxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','emailTemplateId'=>'46xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx']);
		$this->assertEquals($appointmentTemplateComplex['mock-content'],1);
		$appointmentTemplateComplex=$sdk->appointmentTemplate_smsTemplate_link(['organizationId'=>'f6xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','appointmentTemplateId'=>'vcxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','smsTemplateId'=>'6Gxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx']);
		$this->assertEquals($appointmentTemplateComplex['mock-content'],1);
		$appointmentTemplateComplex=$sdk->appointmentTemplate_smsTemplate_unlink(['organizationId'=>'f6xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','appointmentTemplateId'=>'vcxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','smsTemplateId'=>'6Gxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx']);
		$this->assertEquals($appointmentTemplateComplex['mock-content'],1);
		$appointmentTemplateComplex=$sdk->appointmentTemplate_timeGrid_listWeek(['organizationId'=>'f6xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','appointmentTemplateId'=>'vcxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','year'=>'2021','week'=>'41']);
		$this->assertEquals($appointmentTemplateComplex['mock-content'],1);
		...
		$appointmentTemplateComplex=$sdk->appointmentTemplate_timeGrid_edit(['organizationId'=>'f6xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx','appointmentTemplateId'=>'vcxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx'],$data);
		$this->assertEquals($appointmentTemplateComplex['mock-content'],1);

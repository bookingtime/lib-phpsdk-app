...
class SmsRoute extends Route {
	...
	public function show(array $urlParameter,$expectedResponseCode) {
		...
		//make request to API
		$this->checkUrlParameters(['organizationId','smsId'],$urlParameter);
		$response=$this->httpClient->request('GET','/organization/'.$urlParameter['organizationId'].'/sms/'.$urlParameter['smsId'].'/show',[],$expectedResponseCode);
	...
	public function index(array $urlParameter,$all,$expectedResponseCode) {
		...
		$response=$this->httpClient->request('GET','/organization/'.$urlParameter['organizationId'].'/sms/'.($all?'indexAll':'index').'/'.($urlParameter['page']?$urlParameter['page']:'1'),[],$expectedResponseCode);
		#die(BasicLib::debug($response));
		return $response['content'];
	}
	...
	public function filter(array $urlParameter,$all,$expectedResponseCode) {
		...
		$response=$this->httpClient->request('GET','/organization/'.$urlParameter['organizationId'].'/sms/'.($all?'filterAll':'filter').'/'.($urlParameter['page']?$urlParameter['page']:'1').'?searchQuery='.$urlParameter['searchQuery'],[],$expectedResponseCode);
		#die(BasicLib::debug($response));
		return $response['content'];
	}
	...
	public function list(array $urlParameter,$all,$expectedResponseCode) {
		...
		$response=$this->httpClient->request('GET','/organization/'.$urlParameter['organizationId'].'/sms/'.($all?'listAll':'list'),[],$expectedResponseCode);
		#die(BasicLib::debug($response));
		return $response['content'];
	}
	...
	public function resend(array $urlParameter,$expectedResponseCode) {
		...
		//make request to API
		$this->checkUrlParameters(['organizationId','smsId'],$urlParameter);
		$response=$this->httpClient->request('POST','/organization/'.$urlParameter['organizationId'].'/sms/'.$urlParameter['smsId'].'/resend',[],$expectedResponseCode);
		#die(BasicLib::debug($response));
		return $response['content'];
	}
	...
	public function customerIndex(array $urlParameter,$expectedResponseCode) {
		...
		$response=$this->httpClient->request('GET','/organization/'.$urlParameter['organizationId'].'/customer/'.$urlParameter['customerId'].'/sms/index/'.($urlParameter['page']?$urlParameter['page']:'1'),[],$expectedResponseCode);
		#die(BasicLib::debug($response));
		return $response['content'];
	}
	...
	public function customerFilter(array $urlParameter,$expectedResponseCode) {
		...
		//make request to API
		$this->checkUrlParameters(['organizationId','customerId','page'],$urlParameter);
		$response=$this->httpClient->request('GET','/organization/'.$urlParameter['organizationId'].'/customer/'.$urlParameter['customerId'].'/sms/filter/'.($urlParameter['page']?$urlParameter['page']:'1').'?searchQuery='.$urlParameter['searchQuery'],[],$expectedResponseCode);
		#die(BasicLib::debug($response));
		return $response['content'];
	}
	...
	public function customerList(array $urlParameter,$expectedResponseCode) {
		...
		$response=$this->httpClient->request('GET','/organization/'.$urlParameter['organizationId'].'/customer/'.$urlParameter['customerId'].'/sms/list',[],$expectedResponseCode);
		#die(BasicLib::debug($response));
		return $response['content'];
	}

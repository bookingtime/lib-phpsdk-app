...
class ModuleRoute extends Route {
	...
	public function show(array $urlParameter,$expectedResponseCode) {
		...
		$response=$this->httpClient->request('GET','organization/'.$urlParameter['organizationId'].'/module/'.$urlParameter['moduleId'].'/show',[],$expectedResponseCode);
	...
	public function index(array $urlParameter,$expectedResponseCode) {
		...
		$response=$this->httpClient->request('GET','organization/'.$urlParameter['organizationId'].'/module/index/'.($urlParameter['page']?$urlParameter['page']:'1'),[],$expectedResponseCode);
		#die(BasicLib::debug($response));
		return $response['content'];
	}
	...
	public function filter(array $urlParameter,$expectedResponseCode) {
		...
		$response=$this->httpClient->request('GET','organization/'.$urlParameter['organizationId'].'/module/filter/'.($urlParameter['page']?$urlParameter['page']:'1').'?searchQuery='.$urlParameter['searchQuery'],[],$expectedResponseCode);
		#die(BasicLib::debug($response));
		return $response['content'];
	}
	...
	public function list(array $urlParameter,$expectedResponseCode) {
		...
		$response=$this->httpClient->request('GET','organization/'.$urlParameter['organizationId'].'/module/list',[],$expectedResponseCode);
		#die(BasicLib::debug($response));
		return $response['content'];
	}
}

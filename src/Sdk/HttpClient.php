...
class HttpClient {
	 ...
	 * @return	array		buzz response with message and content
	 */
	public function request($method,$requestUrlSuffix,array $requestContent,$expectedResponseCode,$expectedJsonReponse=TRUE):array {
		//check submitted parameters
